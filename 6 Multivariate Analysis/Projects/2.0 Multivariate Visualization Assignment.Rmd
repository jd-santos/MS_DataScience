---
title: "2.0-Multivariate_Visualization_Assignment"
author: "JD Santos"
date: "10/24/2020"
output: pdf_document
---
...
```
This assignment uses the MVA, HSAUR, Kernsmooth...packages
```{r}
...
text(USairpollution$temp, USairpollution$precip, cex = 0.6, labels = abbreviate(row.names(USairpollution)))
```
...
**The correlation matrices are extremely close, in this case it appears that any of these methods would give you an accurate value. From this, I would speculate that there are few nulls in the data. This could be because some responses are enforced through the survey software, or that students don't feel the need to skip questions. That said, knowing that our data is distributed fairly normally it would be best to use maximum likelihood estimates to impute these nulls.**
